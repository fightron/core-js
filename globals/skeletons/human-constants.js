...
export const TOES_HEIGHT = FOOT_HEIGHT / 2.5
export const TOES_WIDTH = FOOT_WIDTH * 0.8
export const TOES_DEPTH = FOOT_DEPTH / 1.2
...
export const PALM_WIDTH = ARM_LOWER_WIDTH * 1.2 * HAND_SCALE
export const PALM_DEPTH = ARM_LOWER_DEPTH * 0.3 * HAND_SCALE
...
export const FINGER_DEPTH = PALM_DEPTH

const THUMB_HEIGHT_SCALE = 1.2
export const THUMB_DEPTH = FINGER_DEPTH
export const THUMB_WIDTH = FINGER_WIDTH * 1.2
