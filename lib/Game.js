...
import testPose3L0 from '../test/fixtures/poses/test-3-l-0'
...
export class Game extends Base {
  ...
  demo () {
    ...
    this.sendToClient('+', 'po', testPose3L0)

    this.sendToClient('po', '1-1', 'test-3-l-0')
    this.sendToClient('po', '1-2', 'test-3')
