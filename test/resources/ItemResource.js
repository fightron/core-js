...
import triangleItem from '../fixtures/item-triangles'
...
describe('resources/ItemResource', function () {
  ...
  describe('#patch', function () {
    ...
    it('names parts correctly', function () {
      expect(this.item.parts[0].id).to.equal('three-triangles-1')
      expect(this.item.parts[1].id).to.equal('three-triangles-2')
      expect(this.item.parts[2].id).to.equal('three-triangles-3')
    })
