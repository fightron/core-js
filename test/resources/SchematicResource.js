...
describe('resources/SchematicResource', function () {
  ...
  describe('#patch', function () {
    ...
    it('positions parts correctly', function () {
      ...
      expect(this.item.parts[3].position.y).to.equal(101)
    })

    it('rotates parts correctly', function () {
      expect(this.item.parts[1].rotation.y).to.equal(1)
    })

    it('scales parts correctly', function () {
      expect(this.item.parts[3].scale.x).to.equal(2)
      expect(this.item.parts[3].scale.z).to.equal(2)
    })
